...
from utils.convert import to_gpu
from utils.time_track import time_desc_decorator
from utils.functions import DiffLoss, MSE, SIMSE, CMD
import models
...
class Solver(object):
    ...
    def build(self, cuda=True):
        ...
        # self.model.load_state_dict(torch.load(f'checkpoints/model_2024-07-22_19:47:44.std'))
        # self.optimizer.load_state_dict(torch.load(f'checkpoints/optim_2024-07-22_19:47:44.std'))
    ...
    def train(self):
        ...
        for e in range(self.train_config.n_epoch):
            ...
            for batch in tqdm(self.train_data_loader):
                ...
                input_ids, attention_masks, token_type_ids = text_input['input_ids'].squeeze(1), text_input['attention_mask'].squeeze(1), text_input['token_type_ids'].squeeze(1)
                ...
                y_tilde = self.model(vision, input_ids, attention_masks, token_type_ids)
