...
def  get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--n_epoch', type=int, default=36)
    ...
    parser.add_argument('--private_t_weight', type=float, default=1)
    parser.add_argument('--private_v_weight', type=float, default=1)
    parser.add_argument('--shared_t_weight', type=float, default=1)
    parser.add_argument('--shared_v_weight', type=float, default=1)
